...
export class EmpleadoService {
  ...
  async create(createEmpleadoInput: CreateEmpleadoInput): Promise<Empleado> {
    ...
    if (!createEmpleadoInput.estacionId) {
      estacionInput =
        createEmpleadoInput.estacionId === null
          ? {
              disconnect: true,
            }
          : undefined;
    ...
    try {
      ...
      const createEmpleadoPayload = await prisma.empleado.create({
        data: {
  ...
  async update(
    ...
    if (!updateEmpleadoInput.estacionId) {
      estacionInput =
        updateEmpleadoInput.estacionId === null ||
        updateEmpleadoInput.estacionId === ''
          ? {
              disconnect: true,
            }
          : undefined;
    ...
    if (!updateEmpleadoInput.usuario) {
      usuarioInput =
        updateEmpleadoInput.usuario === null
          ? {
              disconnect: true,
            }
          : undefined;
