...
export abstract class IQuery {
  abstract conceptosFactura(
    facturaId: string,
  ): Nullable<ConceptoFactura>[] | Promise<Nullable<ConceptoFactura>[]>;

  abstract conceptoFactura(
    id: string,
  ): Nullable<ConceptoFactura> | Promise<Nullable<ConceptoFactura>>;
  ...
  abstract empleado(
    id: string,
  ): Nullable<Empleado> | Promise<Nullable<Empleado>>;

  abstract estaciones(): Nullable<Estacion>[] | Promise<Nullable<Estacion>[]>;

  abstract estacion(
    id: string,
  ): Nullable<Estacion> | Promise<Nullable<Estacion>>;

  abstract estacionesDisponibles():
    | Nullable<Estacion>[]
    | Promise<Nullable<Estacion>[]>;
  ...
  abstract eventoByEstacion(
    estacionId: string,
  ): Nullable<Evento> | Promise<Nullable<Evento>>;
  ...
  abstract facturaByFolio(
    folio?: Nullable<number>,
  ): Nullable<Factura> | Promise<Nullable<Factura>>;
  ...
  abstract producto(
    id: string,
  ): Nullable<Producto> | Promise<Nullable<Producto>>;

  abstract availableProductos():
    | Nullable<Producto>[]
    | Promise<Nullable<Producto>[]>;

  abstract servicios(): Nullable<Servicio>[] | Promise<Nullable<Servicio>[]>;

  abstract servicio(
    id: string,
  ): Nullable<Servicio> | Promise<Nullable<Servicio>>;

  abstract availableServicios():
    | Nullable<Servicio>[]
    | Promise<Nullable<Servicio>[]>;
...
export abstract class IMutation {
  abstract createConceptoFactura(
    createConceptoFacturaInput: CreateConceptoFacturaInput,
  ): ConceptoFactura | Promise<ConceptoFactura>;

  abstract updateConceptoFactura(
    updateConceptoFacturaInput: UpdateConceptoFacturaInput,
  ): ConceptoFactura | Promise<ConceptoFactura>;

  abstract removeConceptoFactura(
    id: string,
  ): Nullable<ConceptoFactura> | Promise<Nullable<ConceptoFactura>>;

  abstract createEmpleado(
    createEmpleadoInput: CreateEmpleadoInput,
  ): Empleado | Promise<Empleado>;

  abstract updateEmpleado(
    updateEmpleadoInput: UpdateEmpleadoInput,
  ): Empleado | Promise<Empleado>;

  abstract removeEmpleado(
    id: string,
  ): Nullable<Empleado> | Promise<Nullable<Empleado>>;

  abstract createEstacion(
    createEstacionInput: CreateEstacionInput,
  ): Estacion | Promise<Estacion>;

  abstract updateEstacion(
    updateEstacionInput: UpdateEstacionInput,
  ): Estacion | Promise<Estacion>;

  abstract removeEstacion(
    id: string,
  ): Nullable<Estacion> | Promise<Nullable<Estacion>>;

  abstract createEvento(
    createEventoInput: CreateEventoInput,
  ): Evento | Promise<Evento>;

  abstract updateEvento(
    updateEventoInput: UpdateEventoInput,
  ): Evento | Promise<Evento>;

  abstract removeEvento(
    id: string,
  ): Nullable<Evento> | Promise<Nullable<Evento>>;

  abstract createFactura(
    createFacturaInput: CreateFacturaInput,
  ): Factura | Promise<Factura>;

  abstract updateFactura(
    updateFacturaInput: UpdateFacturaInput,
  ): Factura | Promise<Factura>;

  abstract removeFactura(
    id: string,
  ): Nullable<Factura> | Promise<Nullable<Factura>>;

  abstract cancelFactura(
    id: string,
  ): Nullable<Factura> | Promise<Nullable<Factura>>;

  abstract saveFactura(
    id: string,
  ): Nullable<Factura> | Promise<Nullable<Factura>>;

  abstract realizarPago(
    realizarPagoInput: RealizarPagoInput,
  ): Pago | Promise<Pago>;
  ...
  ): Producto | Promise<Producto>;

  abstract updateProducto(
    updateProductoInput: UpdateProductoInput,
  ): Producto | Promise<Producto>;

  abstract removeProducto(
    id: string,
  ): Nullable<Producto> | Promise<Nullable<Producto>>;

  abstract createServicio(
    createServicioInput: CreateServicioInput,
  ): Servicio | Promise<Servicio>;

  abstract updateServicio(
    updateServicioInput: UpdateServicioInput,
  ): Servicio | Promise<Servicio>;

  abstract removeServicio(
    id: string,
  ): Nullable<Servicio> | Promise<Nullable<Servicio>>;
